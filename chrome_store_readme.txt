Simplifiez la gestion des réservations périscolaires, de la restauration scolaire et des factures du Portail Famille de Saint-Maur-des-Fossés.
...
1. Connectez-vous au Portail Famille de Saint-Maur-des-Fossés.
...
- Aucune donnée personnelle n’est sauvegardée par l’extension.
- Les réservations et factures sont traitées localement dans votre navigateur.
- Les données ne sont envoyées à Google que si vous utilisez volontairement la synchronisation Google Calendar.
- Le code source est ouvert et transparent : https://github.com/zhitongLIU/saint_maur_family_portal_extension

Cette extension n’est pas affiliée à la Ville de Saint-Maur-des-Fossés ni à AgoraPlus. Elle est proposée comme outil pratique pour les familles utilisatrices du Portail Famille.

Vos suggestions sont les bienvenues pour améliorer l’extension.
